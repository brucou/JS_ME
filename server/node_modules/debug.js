...
exports.write = function (tag, text, arg) {
    ...
    */
   var i;
   if (tag === exports.TAG.DEBUG && !exports.FLAG.DEBUG) {
      return;
   }
   if (arg) {
      for (i = 2; i != arguments.length; i++) {
         if (!arguments[i]) {
            text += exports.SEP.ARG + "??"
         } else {
            text += exports.SEP.ARG + arguments[i].toString();
         }
      }
   }
   console.log(tag + exports.SEP.TAG + text);
};
