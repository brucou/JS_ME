 ...
 * todo:
 * dismiss mousemove
 * traiter le cas niveau serveur quand lexicalize retourne plusieurs lemmes (prendre le premier seulement?)
...
define(['jquery',
       ...
       function ($, MUSTACHE, DS, RM, RV, UT) {
         ...
         ({
            ...
            defaults       : {dismiss_on: 'mousemove'}, //todo : pas fait encore
            $tooltip       : null,
            ...
            show_translation: function (word, ev) {
              ...
              RM.cached_translation(word, function (err, aValues) {
                ...
                $("#reader-tool-tooltip").append(frag);
                TC.viewTranslateAdapter.set_HTML_tooltip("");
